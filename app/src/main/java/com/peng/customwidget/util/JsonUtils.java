...
public class JsonUtils {
    ...
    // 采取单例模式
    private static Gson gson = new GsonBuilder().disableHtmlEscaping().serializeNulls().create();// serializeNulls: Object 转为json时，保留null字段
    private JsonUtils() {
    }
    ...
    public static Object fromJson(String json, Type typeOfT) {
        try {
            ...
            System.err.print("================json 解析错误：" + e.getLocalizedMessage());
            LogUtils.e("json 解析错误："+e.getLocalizedMessage());
        }
        return null;
    }
